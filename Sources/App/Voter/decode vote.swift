...
func decodeAndStore<V: SupportedVoteType>(group: Group, vote: V, constituent: Constituent, req: Request, forAPI: Bool) async -> ((data: V.ReceivedData?, error: Error)?, [String]?){
